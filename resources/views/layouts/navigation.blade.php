<nav class="navbar fixed-top">
   ...
   <a class="navbar-logo" href="Dashboard.Default.html">
        <span class=" d-none d-xs-block"><img src="{{ asset('assets/logos/fulllogo.png') }}" height=50 /></span>
        <span class=" d-block d-xs-none"><img src="{{ asset('assets/logos/logo.png') }}" height=40 /></span>
    </a>
