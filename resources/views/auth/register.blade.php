                        ...
                        <div class="form-side" style="height:500px; overflow-y:scroll;">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group ">
                                    ...
                                    autofocus autocomplete="name" placeholder="Eg. John">
                                </div>
                                <div class="form-group ">
                                    <label >Surname</label>
                                    <input type="text" class="form-control" id="surname" placeholder="Eg. Doe">
                                </div>
                                <div class="form-group ">
                                    <label >Email</label>
                                    <input type="text" class="form-control" id="email" name="email" :value="old('email')"
                                    required autocomplete="username"  placeholder="Eg. johndoe@gmail.com">
                                </div>
                                <div class="form-group ">
                                    <label >Phone Number</label>
                                    <input type="text" class="form-control" id="phonenumber" name="phonenumber" :value="old('phonenumber')"
                                    required autocomplete="phonenumber" placeholder="Eg. 0720202020">
                                </div>
                                <div class="form-group ">
                                    <label >Country</label>
                                    <select id="countries" name="country"
                                        class=" rounded-lg w-full form-control">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <button class="btn btn-primary btn-lg btn-shadow mt-4" type="submit">REGISTER</button>
                                </div>
                            </form>
                        </div>
                    </div>
